...
namespace Fleetbase\FleetOps\Allocation\Contracts;
 ...
 *
 * Third-party engines can be registered into the AllocationEngineRegistry
 * from any Laravel service provider:
 *
 *   app(AllocationEngineRegistry::class)->register('my-engine', new MyEngine());
 *
 * The registered engine will then appear in the FleetOps allocation settings
