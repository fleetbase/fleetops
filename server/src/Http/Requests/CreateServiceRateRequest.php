...
class CreateServiceRateRequest extends FleetbaseRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'rate_calculation_method'       => [Rule::requiredIf($this->isMethod('POST')), 'string', 'in:per_km,fixed_meter,algo'],
            'currency'                      => 'required|size:3',
            'base_fee'                      => 'numeric',
            'per_km_flat_rate_fee'          => [Rule::requiredIf($this->input(['rate_calculation_method']) === 'rate_calculation_method'), 'numeric'],
