...
class Order extends FleetbaseResource
{
    ...
    public function toArray($request)
    {
        return [
            ...
            'time'                  => (int) $this->time,
            'tracker_data'          => $this->when($request->has('with_tracker_data') || !empty($this->resource->tracker_data), fn () => $this->resource->tracker_data ?? $this->tracker()->toArray()),
            'eta'                   => $this->when($request->has('with_eta') || !empty($this->resource->eta), fn () => $this->resource->eta ?? $this->tracker()->eta()),
