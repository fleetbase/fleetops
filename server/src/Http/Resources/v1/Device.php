...
class Device extends FleetbaseResource
{
    public function toArray($request)
    {
        return $this->withCustomFields([
            ...
            'attachable_type'       => $this->attachable_type ? Utils::toEmberResourceType($this->attachable_type) : null,
            'attachable_id'         => $this->whenLoaded('attachable', fn () => $this->attachable?->public_id),
            'attachable_name'       => $this->whenLoaded('attachable', fn () => $this->attachable?->display_name ?? $this->attachable?->name),
