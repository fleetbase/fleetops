...
class Equipment extends FleetbaseResource
{
    public function toArray($request)
    {
        return $this->withCustomFields([
            ...
            'equipable_type'     => $this->equipable_type ? Utils::toEmberResourceType($this->equipable_type) : null,
            'equipable_id'       => $this->whenLoaded('equipable', fn () => $this->equipable?->public_id),
            'equipable_name'     => $this->whenLoaded('equipable', fn () => $this->equipable?->display_name ?? $this->equipable?->name),
