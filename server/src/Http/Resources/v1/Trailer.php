...
class Trailer extends FleetbaseResource
{
    ...
    public function toArray($request): array
    {
        ...
        return $this->withCustomFields([
            ...
            'category_uuid'        => $this->when($internal, $this->category_uuid),
            'vendor_uuid'          => $this->when($internal, $this->vendor_uuid),
            'warranty_uuid'        => $this->when($internal, $this->warranty_uuid),
            'photo_uuid'           => $this->when($internal, $this->photo_uuid),
            'asset_class'          => 'trailer',
            'name'                 => $this->name,
