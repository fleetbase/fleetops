...
class FleetSeeder extends Seeder
{
    ...
    {
        $vehicles = [
            'van_central'         => ['CEN-01', 'Toyota', 'HiAce', 'GBB-1001', 1.2819, 103.8507, true, 'active', 250, 8, 2, 42],
            'van_east'            => ['EAS-01', 'Nissan', 'NV200', 'GBB-1002', 1.3520, 103.9449, true, 'active', 160, 5, 1, 28],
            ...
            'van_airport'         => ['CGO-05', 'Mercedes-Benz', 'Vito', 'GBB-1005', 1.3644, 103.9915, true, 'active', 220, 7, 2, 36],
            'van_cold_chain'      => ['CLD-06', 'Hyundai', 'H350', 'GBB-1006', 1.3525, 103.9447, true, 'active', 300, 10, 3, 48],
            'truck_west'          => ['JUR-07', 'Hino', '300 Series', 'GBB-1007', 1.3345, 103.7420, true, 'active', 1200, 30, 10, 180],
            'van_linehaul'        => ['LNH-08', 'Ford', 'Transit', 'GBB-1008', 1.3215, 103.7055, false, 'active', 450, 14, 4, 72],
            'van_returns'         => ['RTN-09', 'Peugeot', 'Expert', 'GBB-1009', 1.3150, 103.7649, true, 'active', 180, 6, 1, 32],
            'van_central_2'       => ['CEN-02', 'Toyota', 'HiAce', 'GBB-1010', 1.2871, 103.8550, true, 'active', 250, 8, 2, 42],
            'van_central_3'       => ['CEN-03', 'Nissan', 'NV350', 'GBB-1011', 1.2950, 103.8468, true, 'active', 280, 9, 2, 45],
            'bike_rochor_2'       => ['RCH-11', 'Yamaha', 'NMAX', 'GBB-1012', 1.3042, 103.8528, true, 'active', 25, 1, 0, 6],
            'bike_rochor_3'       => ['RCH-12', 'Honda', 'ADV160', 'GBB-1013', 1.3017, 103.8509, true, 'active', 30, 1, 0, 7],
            'truck_alexandra_1'   => ['ALX-14', 'Mitsubishi Fuso', 'Canter', 'GBB-1014', 1.2868, 103.8054, true, 'active', 850, 20, 6, 120],
            'van_alexandra_2'     => ['ALX-15', 'Ford', 'Transit Custom', 'GBB-1015', 1.2881, 103.8079, false, 'active', 400, 12, 3, 64],
            'van_changi_2'        => ['CGO-16', 'Mercedes-Benz', 'Sprinter', 'GBB-1016', 1.3658, 103.9871, true, 'active', 500, 16, 4, 80],
            'truck_changi_3'      => ['CGO-17', 'Isuzu', 'NPR', 'GBB-1017', 1.3610, 103.9954, true, 'active', 1000, 26, 8, 150],
            'van_tampines_cold_2' => ['CLD-18', 'Hyundai', 'H350', 'GBB-1018', 1.3529, 103.9460, true, 'active', 320, 10, 3, 50],
            'van_tampines_cold_3' => ['CLD-19', 'Toyota', 'HiAce Refrigerated', 'GBB-1019', 1.3498, 103.9425, false, 'maintenance', 260, 8, 2, 40],
            'truck_jurong_2'      => ['JUR-20', 'Hino', '500 Series', 'GBB-1020', 1.3340, 103.7398, true, 'active', 1400, 34, 12, 220],
            'van_jurong_3'        => ['JUR-21', 'Nissan', 'Urvan', 'GBB-1021', 1.3362, 103.7451, true, 'active', 300, 9, 2, 52],
            'truck_linehaul_2'    => ['LNH-22', 'Volvo', 'FL', 'GBB-1022', 1.3210, 103.7032, true, 'active', 1800, 42, 14, 260],
            'van_linehaul_3'      => ['LNH-23', 'Ford', 'Transit', 'GBB-1023', 1.3234, 103.7088, true, 'active', 470, 14, 4, 72],
            'van_returns_2'       => ['RTN-24', 'Peugeot', 'Expert', 'GBB-1024', 1.3168, 103.7660, true, 'active', 180, 6, 1, 32],
