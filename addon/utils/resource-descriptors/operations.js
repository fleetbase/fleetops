...
export default function buildOperationsDescriptors(owner) {
    return [
        ...
        },
        {
            ...
            statusTones: { created: 'text-gray-400', preparing: 'text-yellow-500', dispatched: 'text-yellow-500', started: 'text-yellow-500', in_progress: 'text-yellow-500', enroute: 'text-yellow-500', completed: 'text-green-500', delivered: 'text-green-500', canceled: 'text-red-500', cancelled: 'text-red-500', failed: 'text-red-500' },
        ...
        },
        {
            ...
            badges: (manifest) => badges(badge('stops', 'list-ol', present(get(manifest, 'stop_count')) ? `${get(manifest, 'completed_stops') ?? 0}/${get(manifest, 'stop_count')} stops` : null)),
