    ...
    return [
        {
            ...
            statusTones: { low: 'text-gray-400', medium: 'text-yellow-500', high: 'text-red-500', critical: 'text-red-500', scheduled_maintenance: 'text-yellow-500', resolved: 'text-green-500', completed: 'text-green-500', pending: 'text-yellow-500', in_progress: 'text-yellow-500' },
        ...
        },
        {
            ...
            facts: (schedule) => [
                ...
                relatedFact('assignee', relation(owner, schedule, 'default_assignee'), polymorphicType(schedule, 'default_assignee', 'default_assignee_type'), first(schedule, 'default_assignee_name')),
