...
// ─── Phase 2: Settings / tenancy options ──────────────────────────────────────
...
/**
 * US state / territory codes (Phase 2 Task 14).
 * Used by the ServiceArea form's `states_list` PowerSelectMultiple.
 * Values are 2-letter postal codes (uppercase) — match locked spec for
 * service_areas.states_list (array of string codes).
 */
