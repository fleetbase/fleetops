...
export default class MapLeafletLiveMapComponent extends Component {
    ...
    @task *load() {
        try {
            ...
            this.trigger('didLoad', { map: this.map, data });
            this.ready = true;
        } catch (err) {
    ...
    #createMapContextMenu(map) {
        const items = [
            ...
            { separator: true },
            {
                ...
                callback: () => this.serviceAreaManager.createServiceArea(),
                index: 5,
            },
    ...
    #createZoneContextMenu(zone, layer) {
        let items = [
            ...
            {
                text: `Edit Boundaries: ${zone.name}`,
    ...
    #createServiceAreaContextMenu(serviceArea, layer) {
        let items = [
            ...
            {
                text: `Edit Boundaries: ${serviceArea.name}`,
