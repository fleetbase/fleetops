...
export default class LayoutFleetOpsSidebarComponent extends Component {
    ...
    get maintenanceItems() {
        return this.withRegistryItems('maintenance', [
            ...
            this.createItem('menu.inspection-forms', 'clipboard-check', 'maintenance.inspection-forms', 'fleet-ops list inspection-form', 'fleet-ops see inspection-form', ['dvir', 'checklist']),
            this.createItem('menu.inspections', 'list-check', 'maintenance.inspection-submissions', 'fleet-ops list inspection-submission', 'fleet-ops see inspection-submission', ['dvir', 'defects']),
