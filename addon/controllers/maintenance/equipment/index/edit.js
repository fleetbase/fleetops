...
export default class MaintenanceEquipmentIndexEditController extends Controller {
    @service hostRouter;
    @service intl;
    ...
    #confirmContinueWithUnsavedChanges(equipment, options = {}) {
        return this.modalsManager.confirm({
            ...
            body: this.intl.t('common.continue-without-saving-prompt', { resource: this.intl.t('resource.equipment') }),
