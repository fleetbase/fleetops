...
export default class MaintenanceEquipmentIndexDetailsController extends Controller {
    ...
    get tabs() {
        ...
        return [
            { route: 'console.fleet-ops.maintenance.equipment.index.details.index', label: this.intl.t('common.overview') },
    ...
    get actionButtons() {
        return [
            ...
            { icon: 'trash', fn: this.delete, permission: 'fleet-ops delete equipment' },
        ];
    }
