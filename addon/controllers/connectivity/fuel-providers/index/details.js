...
export default class ConnectivityFuelProvidersIndexDetailsController extends Controller {
    ...
    get tabs() {
        return [
            { route: 'connectivity.fuel-providers.index.details.index', label: 'Overview' },
            { route: 'connectivity.fuel-providers.index.details.sync', label: 'Sync' },
            { route: 'connectivity.fuel-providers.index.details.matching', label: 'Matching' },
            { route: 'connectivity.fuel-providers.index.details.transactions', label: 'Transactions' },
            { route: 'connectivity.fuel-providers.index.details.settings', label: 'Settings' },
        ].map((tab) => ({
            ...tab,
